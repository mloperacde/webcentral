...
const translations: Record<Language, Record<string, any>> = {
  ...
  en: {
    ...
    "copacker.feature3.desc": "Total certification and traceability: Manufacturing in sanitary areas and packaging in 6 certified Clean Rooms and one Sterile Packaging Room, with own purified water generation plant (700 L/h). We eliminate cross-contamination risks and guarantee batch traceability from raw material to final pallet.",
