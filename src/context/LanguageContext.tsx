...
const translations: Record<Language, Record<string, any>> = {
  es: {
    ...
    "instalaciones.title": "Instalaciones: Arquitectura de Grado Farmacéutico",
    "instalaciones.subtitle": "Capacidad Industrial Certificada",
    "instalaciones.manufacturing.title": "Fabricación de Grado Superior",
    ...
    "instalaciones.cleanrooms.title": "7 Salas Blancas Certificadas",
    ...
    "instalaciones.warehouse.description": "Gestión integral de componentes con sistemas de validación clínica de cada lote.",
    ...
    "calidad.process.description": "Implementamos trazabilidad digital completa y validación clínica en cada fase, asegurando que cada unidad cumpla con los estándares de pureza farmacéutica.",
  ...
  en: {
    ...
    "nosotros.p2": "This evolution, based on continuous reinvestment and talent retention, has allowed us to scale without losing our essence: more than 250 specialized professionals daily manage critical operations from our more than 30 packaging rooms, 7 of them certified clean rooms, and our own purified water plant for the manufacture of healthcare and cosmetic products.",
    ...
    "copacker.feature3.desc": "Total certification and traceability: Manufacturing in sanitary areas and packaging in 7 certified Clean Rooms, with own purified water generation plant (700 L/h). We eliminate cross-contamination risks and guarantee batch traceability from raw material to final pallet.",
    ...
    "productos.items.vials.capacity": "1 ML - 30 ML",
    "instalaciones.title": "Facilities: Pharmaceutical Grade Architecture",
    "instalaciones.subtitle": "Certified Industrial Capacity",
    "instalaciones.manufacturing.title": "Superior Grade Manufacturing",
    "instalaciones.manufacturing.description": "Critical formula development under aseptic protocols and total digital control.",
    "instalaciones.cleanrooms.title": "7 Certified Clean Rooms",
